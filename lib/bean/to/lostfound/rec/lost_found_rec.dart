...
LostFoundRec lostFoundRecFromJson(String str) =>
    LostFoundRec.fromJson(json.decode(str));

String lostFoundRecToJson(LostFoundRec data) => json.encode(data.toJson());
...
class LostFoundRec {
  ...
  factory LostFoundRec.fromJson(Map<String, dynamic> json) => LostFoundRec(
        id: json["id"],
        userId: json["userId"],
        lostId: json["lostId"],
        type: json["type"],
